...
class NASNetAMobile(nn.Module):
    ...
    def __init__(self, num_classes=1000, stem_filters=32, penultimate_filters=1056, filters_multiplier=2):
        ...
        self.conv0.add_module('conv', nn.Conv2d(in_channels=1, out_channels=self.stem_filters, kernel_size=3, padding=0, stride=2,
                                                bias=False))
        ...
        self.last_linear = nn.Linear(7392, self.num_classes)

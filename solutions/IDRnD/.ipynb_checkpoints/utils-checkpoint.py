...
class Train:
    def __init__(self, model_path="weight_best.pt", gradient_acumulation=[], callbacks=[]):
    ...
    def fit(
        ...
        for epoch in range(epoches):
            ...
            for callback in self.callbacks:
                callback.on_epoch_end(epoch=epoch, y_true=val_loader.dataset.y, y_pred=valid_preds.reshape(-1),
                                     model=model.module)
